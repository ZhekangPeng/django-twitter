...
SECRET_KEY = 'vtns!$1c*6wf(#-ffe1k%8!8jhk((bx5o(f=h0#!jhetar!oax'
...
AWS_STORAGE_BUCKET_NAME = 'zach-django-twitter'
...
RATELIMIT_CACHE_PREFIX = 'rl:'  # To make the key distinctive
RATELIMIT_ENABLE = not TESTING  # Ratelimiter disabled in Dev
